...
class DangerDetector:
    ...
    def __init__(
        self,
        model_path: str = "models/signs_b.pt",
    ...
    def _load_model(self, model_path: str) -> None:
        """signs_b.pt 모델을 로드하고 클래스 ID를 매핑한다."""
        ...
        # 클래스 이름 매핑 — signs_b.pt의 클래스 이름에 맞춰 자동 탐색
