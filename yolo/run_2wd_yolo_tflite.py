...
from motor_2wd import Motor2WD  # 2륜 모터 제어 클래스를 가져옵니다.
...
def main() -> None:  # 2륜 로봇 실행 메인 함수입니다.
    ...
    try:  # 실행 중 예외가 나도 모터를 정지시키기 위한 try 블록입니다.
        while True:  # 사용자가 종료할 때까지 계속 반복합니다.
            ...
            motors.apply(command)  # 2륜 모터에 명령을 적용합니다.
            ...
            if DEBUG:  # 디버그 화면이 켜져 있으면 실행합니다.
                ...
                cv2.imshow("2WD YOLO TFLite Robot", display)  # 디버그 창을 표시합니다.
